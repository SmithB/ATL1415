...
# Written 2026-09-17.  TENTATIVE -- NO CODE YET.  Revise as steps land.
# ===========================================================================
...
# smoke tile.  See QL1.  NOT in scope here; recorded so nobody discovers it
# by submitting 28 jobs that all come back empty.
#
#
# ===========================================================================
...
#
# ===========================================================================
# L1. [NOT STARTED]  Decide the storage layout.   RECOMMENDATION + QL2
# ===========================================================================
# RECOMMENDATION: one HDF5 group per granule,
...
#      measures it for real.  Hoisting this into pointCollection so the query
#      reuses its open handle is possible but crosses repos -- not worth it
#      at this cost.  (QL3 if the measurement disagrees.)
...
#   e. the INVALID warning counts only files still missing something, so a
#      fully recorded run prints none -- that is the check in L7.
#   f. old tiles (no /meta/lineage) keep today's behaviour: name attributes
...
# on [int32, int32] as an int32 array.  So an attribute's type in the product
# depends on whether any row is invalid.  The pre-28b4f72 code behaved the
# same way whenever a row was NOT_SET.  L7 records the types a fully valid
# run produces.  (QL4.)
#
#
# ===========================================================================
...
#
# ===========================================================================
# L6. [DPS] [BLOCKED: the ATL11 generation, see the top, and QL1]
