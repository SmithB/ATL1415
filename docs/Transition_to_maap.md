...
[x] STALE IMAGES: RESOLVED 2026-09-11 (Ben).  Workers stopped running stale images once the
    ADE moved to maap-py 5; what remains is an audit trail.  Every job logs its build and
