...
# note- need to make new versions of these two files:
...
make_field_size_report.py /discover/nobackup/projects/icesat2/ATL14_processing/rel005/north/GL/prelim
...
make_mosaic_jobs.py -b /discover/nobackup/projects/icesat2/ATL14_processing/rel005/north/GL -rr GL -t 2018.75,2026.0
